...
tape( 'if provided `-infinity` for `x` and a finite `mu` and `b`, the function returns `-Infinity`', opts, function test( t ) {
	var y = logcdf( NINF, 0.0, 1.0 );
	t.strictEqual( y, NINF, 'returns expected value' );
	t.end();
});

tape( 'if provided a negative `b`, the function returns `NaN`', opts, function test( t ) {
	var y;
